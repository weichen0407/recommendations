...
| 存储值 | 目录名称 | 所属一级行业 |
| --- | --- | --- |
| medical_imaging | Medical Imaging Equipment & Diagnostic Imaging Software | medical_devices |
| in_vitro_diagnostics | In Vitro Diagnostics & Molecular Testing | medical_devices |
| diabetes_monitoring_delivery | Diabetes Monitoring & Insulin Delivery Devices | medical_devices |
| surgical_robotics | Surgical Robotics & Minimally Invasive Surgical Systems | medical_devices |
| engineering_polymers_composites | Engineering Polymers & Composites | materials |
| specialty_metals_alloys | Specialty Metals & Alloys | materials |
| technical_ceramics_glass | Technical Ceramics & Specialty Glass | materials |
| battery_materials_recycling | Battery Materials & Recycling | materials |
| automotive_electrified_powertrains | Automotive Electrified Powertrains | automotive |
| adas_automated_driving | ADAS & Automated Driving Systems | automotive |
| automotive_chassis_body | Automotive Chassis & Body Components | automotive |
| commercial_special_vehicles | Commercial & Special-Purpose Vehicles | automotive |
| semiconductors | Semiconductors | electronics_manufacturing |
| electronic_components_interconnects | Electronic Components & Interconnects | electronics_manufacturing |
| computing_network_hardware | Computing & Network Hardware | electronics_manufacturing |
| photonics_optical_sensing | Photonics & Optical Sensing Systems | electronics_manufacturing |
| industrial_robotics_automation | Industrial Robotics & Automation | engineering |
| industrial_machinery | Industrial Machinery & Production Equipment | engineering |
| additive_manufacturing_systems | Additive Manufacturing Equipment & Systems | engineering |
| engineering_design_services | Engineering Design & Technical Consulting Services | engineering |
| antibody_protein_medicines | Antibody & Therapeutic Protein Medicines | biotech |
| cell_gene_therapies | Cell & Gene Therapies | biotech |
| biologics_process_manufacturing | Biologics Process Development & Contract Manufacturing | biotech |
| industrial_enzymes_microorganisms | Industrial Enzymes & Microorganisms | biotech |
| life_science_research_tools | Life Science Research Tools & Laboratory Instruments | biotech |
| agricultural_machinery_precision_farming | Agricultural Machinery & Precision Farming Systems | food_farming_production |
| seeds_crop_breeding | Seeds & Crop Breeding | food_farming_production |
| frozen_prepared_foods | Frozen & Prepared Foods | food_farming_production |
| food_ingredients_nutrition | Food Ingredients & Nutritional Components | food_farming_production |
| batteries_stationary_storage | Batteries & Stationary Energy Storage | energy |
| grid_power_equipment | Grid & Power Equipment | energy |
| solar_photovoltaics | Solar Photovoltaics | energy |
| hydrogen_fuel_cell_equipment | Hydrogen & Fuel Cell Equipment | energy |
| electronic_chemicals | Electronic Chemicals | chemical |
| coatings_adhesives_sealants | Coatings, Adhesives & Sealants | chemical |
| industrial_specialty_gases | Industrial & Specialty Gases | chemical |
| renewable_fuels | Renewable Fuels | chemical |
| building_hvac_heat_pumps | Building HVAC & Heat Pumps | construction |
| cement_concrete | Cement & Concrete | construction |
| prefabricated_modular_buildings | Prefabricated & Modular Buildings | construction |
| water_wastewater_infrastructure | Water & Wastewater Infrastructure | construction |
| aerospace_space | Aerospace & Space | other |

### 6.6 具体任务：36 类

| 存储值 | 目录名称 |
| --- | --- |
| solution_search | Find technical solutions |
| solution_comparison | Compare technical solutions |
| failure_resolution | Resolve technical failures |
| process_optimization | Optimize processes |
| technology_landscape | Map existing technologies |
| product_ideation | Generate product concepts |
| feasibility_assessment | Assess technical feasibility |
| validation_planning | Plan validation |
| research_field_exploration | Explore research fields |
| research_gap_identification | Identify research gaps |
| research_method_search | Find research methods |
| research_method_comparison | Compare research methods |
| research_ideation | Generate research ideas |
| evidence_search | Search patents and literature |
| evidence_synthesis | Synthesize research evidence |
| research_trend_tracking | Track research trends |
| technology_trend_tracking | Track technology trends |
| competitor_tracking | Track competitors |
| innovation_opportunity_identification | Identify innovation opportunities |
| rd_direction_prioritization | Prioritize R&D directions |
| patent_landscape_analysis | Analyze patent landscapes |
| prior_art_search | Search prior art |
| novelty_comparison | Compare novelty-related features |
| fto_evidence_search | Search FTO evidence |
| design_risk_analysis | Analyze design-related patent risk |
| ip_risk_identification | Identify IP risk issues |
| application_drafting | Draft patent applications |
| application_review | Review patent applications |
| claims_drafting | Draft patent claims |
| claims_refinement | Refine patent claims |
| office_action_analysis | Analyze office actions |
| office_action_response | Prepare office action responses |
| licensing_opportunity_assessment | Assess licensing opportunities |
| collaboration_terms_review | Review collaboration and ownership issues |
| ip_portfolio_planning | Plan IP portfolios |
| task_clarification | Clarify the current task |
...
| claims_draft | Claims draft |
| response_outline | Office action response outline |
| transaction_brief | Transaction brief |
| portfolio_plan | Portfolio plan |
| task_menu | Task menu |
| document_template | Working document template |
